...
/**
 * Test for Z-piece {@link ZPiece}.
 * Test whether the Z-piece perform regular rotation and wall kick correctly.
 * 
 * @author Jiameng Li
 * @version 1.0
 */
public class ZPieceRotationTest {

    /** The placeholder used to create scenarios. */
    private final PieceUnit temp = TestHelper.TEMP;

    /** The Z-Piece used to test. */
    private final ZPiece myPiece = new ZPiece();
    ...
    /**
     * Test for {@link ZPiece#rotateClockwise(GameSpace)}.
    ...
    public void testOneToTwoRotate() {
        ...
        TestHelper.copySurrounding(myGameSpace.getPieces(), new PieceUnit[][]{
            {temp, temp, temp, temp, null, null, null, temp, temp, temp},
            {temp, temp, temp, temp, null, null, temp, temp, temp, temp},
            {temp, temp, temp, temp, temp, null, null, temp, temp, temp}
        });
        move = myPiece.rotateClockwise(myGameSpace);
        assertEquals(1, move[0]);
        assertEquals(1, move[1]);
    ...
    /**
     * Test for {@link ZPiece#rotateCounterclockwise(GameSpace)}.
    ...
    /**
     * Test for {@link ZPiece#isValidRotate(PieceUnit[][], int)}.
